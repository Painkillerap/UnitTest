...
public class VehicleTest {
    ...
    @BeforeEach
    public void setUp(){
        car = new Car("Lada", "Granta", 2020);
        motorcycle = new Motorcycle("Honda", "SBR", 2018);
    }
    ...
    public void negativeYearForCarThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> new Car("Lada", "Granta", -2020));
    }

    @Test
    @DisplayName("Отрицательный год выпуска мотоцикла вызывает исключение")
    public void negativeYearForMotorcycleThrowsException() {
        assertThrows(IllegalArgumentException.class, () -> new Motorcycle("Honda", "SBR", -2018));
    }
}
